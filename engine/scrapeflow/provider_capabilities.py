...
# rate-limiting proved it unusable.  The remaining direct download path is
# the local Torrent materializer, which can pass aria2 an exact select-file
# set; AList's offline API cannot express that constraint and is not an
# executable provider.
