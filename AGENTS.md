...
测试基线（2026-08-16 实测）：**864 tests passed, 310 subtests passed, 0 failed**（`python3 -m pytest local/tests/ -q`，35 秒）。
任何代码变更不得使通过数减少。
