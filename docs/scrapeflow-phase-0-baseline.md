...
> 文档性质：2026-08-08 的历史迁移快照，不是当前目标货架启动门的阶段 0，也不证明当前 WIP 已完成。
>
> 长期产品与工程合同见 [`../AGENTS.md`](../AGENTS.md)，当前 HEAD 的实现事实和已知差距见 [`CURRENT-STATE.md`](CURRENT-STATE.md)。本文件是历史阶段快照。
